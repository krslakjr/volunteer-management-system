...
import com.example.participationservice.logging.SystemEventsClient;
...
public class SystemEventLoggerAspect {
    ...
    @Around("@annotation(com.example.participationservice.logging.LoggableAction)")
    public Object logSystemEvent(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        SystemEvent.Builder eventBuilder = SystemEvent.newBuilder()
                ...
                .setMicroservice("participation-service")
