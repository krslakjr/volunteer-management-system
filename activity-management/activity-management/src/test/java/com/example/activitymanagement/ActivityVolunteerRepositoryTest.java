...
public class ActivityVolunteerRepositoryTest {

    @Autowired
    private ActivityVolunteerRepository activityRepository;
    ...
    void testLazyLoadingWithoutNPlusOneProblem() {
        List<ActivityVolunteer> activities = activityRepository.findAll();
