...
public class VolunteerServiceTest {
    ...
    public void testUpdateVolunteerNotFound() {
        ...
        assertThrows(EntityNotFoundException.class, () -> volunteerService.updateVolunteer(1L, updatedVolunteer));
        verify(volunteerRepository, times(1)).findById(1L);
    }
    ...
    public void testDeleteVolunteerNotFound() {
        doThrow(new RuntimeException("Volunteer not found")).when(volunteerRepository).deleteById(1L);

        assertThrows(RuntimeException.class, () -> volunteerService.deleteVolunteer(1L));
        verify(volunteerRepository, times(1)).deleteById(1L);
    }
}
