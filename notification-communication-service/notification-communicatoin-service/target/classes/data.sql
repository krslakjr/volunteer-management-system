...
-- Unos podataka u tabelu Organizer
...
-- Unos podataka u tabelu Activity
...
-- Unos podataka u tabelu Volunteer
...
-- Unos podataka u tabelu EngagementStatistics
-- Koristimo ID-jeve volontera koji su uneti gore
-- Unos podataka u tabelu EngagementStatistics
-- Koristimo ID-jeve volontera koji su uneti u tabelu 'volunteer'
...
-- Unos podataka u tabelu Message
-- Koristimo ID-jeve volontera za sender_id i receiver_id
...
-- Unos podataka u tabelu ForumPost
-- Koristimo ID-jeve volontera i aktivnosti
...
-- Unos podataka u tabelu Notification
-- Koristimo ID-jeve volontera, aktivnosti i organizatora
...
(3, 1, 1, 'Poslata vam je nova poruka!', 'ALERT', '2025-03-21 09:30:00', false),
